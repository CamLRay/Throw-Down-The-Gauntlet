...
const TournamentNav = (props) =>{
  ...
  return (
    ...
    <div className="w-screen bg-slate-700 p-2 pb-0">
      ...
      <Link to='' draggable="false" className={path === `/${param.tournyId}` ? "p-1 mx-3 bg-slate-700 underline underline-offset-4 decoration-amber-500 decoration-4" : "p-1 mx-3 bg-slate-700 hover:decoration-amber-500/50 hover:decoration-4 hover:underline hover:underline-offset-4"}>Bracket</Link>
